<?php
/**
 * Template part for displaying single posts - format gallery.
 *
 * @category WPGarden
 * @package Templates
 * @since 1.0.0
		...
		<div class="warp-relative">
			...
			<div class="col-8-no-last featured-image">
				<?php if (has_post_thumbnail()) {
						...
						printf('<div class="bg-container-image aaa" style="background-image:url(&quot; %1$s &quot;);" ><img src="%1$s" alt="" class="show-small"/><a href="#" class="slider-button gallery-popup"><div>%2$s</div></a></div>',
						 		esc_url(wp_get_attachment_url(get_post_thumbnail_id())),
						 		__('Open in slideshow','wpg_theme')
						);
					} else {
